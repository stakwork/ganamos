...
import { getFilters, saveFilters } from "@/lib/filter-store"
...
export default function SearchPage() {
  ...
  // Load existing filters on mount
  useEffect(() => {
    const currentFilters = getFilters()
    setLocation(currentFilters.location)
    setRewardRange(currentFilters.rewardRange)
    setSelectedDateFilter(currentFilters.dateFilter)
  }, [])
      ...
      <div className="container px-4 mx-auto max-w-md">
        ...
        <div className="space-y-6">
          ...
          <div>
            ...
            <select
              className="w-full mt-1 p-2 border rounded-md dark:border-gray-800 bg-background"
              value={location}
