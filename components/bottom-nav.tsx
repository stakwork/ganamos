...
export function BottomNav() {
  ...
  return (
    <div className="fixed bottom-0 left-0 z-50 w-full h-16 bg-white/80 backdrop-blur-md dark:bg-gray-900/80 flex justify-center">
      <div className="flex h-full w-full max-w-xs mx-auto">
        {/* Dashboard Link - Fixed width container */}
        ...
        {/* New Post Button - Fixed width container */}
        <div className="flex items-center justify-center w-1/3">
          <Link href="/post/new" className="flex items-center justify-center">
        ...
        {/* Profile Link - Fixed width container */}
        <div className="flex items-center justify-center w-1/3">
          <Link
            href="/profile"
            className={cn(
