...
export function BottomNav() {
  ...
  // Don't show bottom nav on home page, auth pages, public job posting page, post creation page, post detail page, or withdraw page
  if (pathname === "/" || pathname.startsWith("/auth") || pathname === "/new" || pathname === "/post/new" || pathname.startsWith("/post/") || pathname.startsWith("/wallet/withdraw")) {
    return null
  }
